...
public class RDrive {
    ...
    public RDrive() {
        ...
        */
                frontLeft = initializeCANJag(RobotDefinitions.FRONTLEFT_DRIVE_JAG_ID, RobotDefinitions.CPR250);
        frontRight = initializeCANJag(RobotDefinitions.FRONTRIGHT_DRIVE_JAG_ID, RobotDefinitions.CPR250);
        backLeft = initializeCANJag(RobotDefinitions.BACKLEFT_DRIVE_JAG_ID, RobotDefinitions.CPR360);
        backRight = initializeCANJag(RobotDefinitions.BACKRIGHT_DRIVE_JAG_ID, RobotDefinitions.CPR360);
    }
    ...
    public void updatePID() {
        try {
            double newP = SmartDashboard.getDouble(RobotDefinitions.DRIVE_PROPORTIONAL);
            double newI = SmartDashboard.getDouble(RobotDefinitions.DRIVE_INTEGRAL);
            double newD = SmartDashboard.getDouble(RobotDefinitions.DRIVE_DIFFERENTIAL);
