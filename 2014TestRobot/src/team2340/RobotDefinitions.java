...
public class RobotDefinitions {
       // names
    public final static String ROBOT_DRIVE_NAME = "Robot Drive";
    public final static String ROBOT_SHOOTER_NAME = "Robot Shooter";
      
    public final static String ROBOT_BALL_COLLECTION = "Robot Ball Collection";

    public final static String ROBOT_CAMERA = "Robot Camera";
    public final static String ROBOT_SONIC_SENSOR = "Robot Sonic Sensor";
    public final static String ROBOT_GYRO_SENSOR = "Robot Gyro Sensor";

    public final static String ROBOT_AUTO_MODE = "Robot Autonomous Mode";
