...
public class LogitechF310 implements Runnable {
    ...
    public LogitechF310(String name, int port) {
        ...
        buttonX = new JoystickButton(joystick, TritionDefinitions.BUTTON_X);
        buttonY = new JoystickButton(joystick, TritionDefinitions.BUTTON_Y);
        buttonA = new JoystickButton(joystick, TritionDefinitions.BUTTON_A);
        buttonB = new JoystickButton(joystick, TritionDefinitions.BUTTON_B);
        buttonLB = new JoystickButton(joystick, TritionDefinitions.BUTTON_LB);
        buttonRB = new JoystickButton(joystick, TritionDefinitions.BUTTON_RB);
        buttonLT = new JoystickButton(joystick, TritionDefinitions.BUTTON_LT);
        buttonRT = new JoystickButton(joystick, TritionDefinitions.BUTTON_RT);
        buttonBack = new JoystickButton(joystick, TritionDefinitions.BUTTON_BACK);
        buttonStart = new JoystickButton(joystick, TritionDefinitions.BUTTON_START);
    ...
    public boolean getX() {
        return joystick.getRawButton(TritionDefinitions.BUTTON_X);
    ...
    public boolean getY() {
        return joystick.getRawButton(TritionDefinitions.BUTTON_Y);
    }
    ...
    public boolean getA() {
        return joystick.getRawButton(TritionDefinitions.BUTTON_A);
    }
    ...
    public boolean getB() {
        return joystick.getRawButton(TritionDefinitions.BUTTON_B);
    }
    ...
    public boolean getLB() {
        return joystick.getRawButton(TritionDefinitions.BUTTON_LB);
    }
    ...
    public boolean getRB() {
        return joystick.getRawButton(TritionDefinitions.BUTTON_RB);
    }
    ...
    public boolean getLT() {
        return joystick.getRawButton(TritionDefinitions.BUTTON_LT);
    }
    ...
    public boolean getRT() {
        return joystick.getRawButton(TritionDefinitions.BUTTON_RT);
    }
    ...
    public boolean getBack() {
        return joystick.getRawButton(TritionDefinitions.BUTTON_BACK);
    }
    ...
    public boolean getStart() {
        return joystick.getRawButton(TritionDefinitions.BUTTON_START);
    }
